        ...
        private void DrawClassicLayout()
{
            ...
            if (ImGui.Begin("Reorder Characters", ref isOpenRef, windowFlags))
            {
                ...
                try
                {
                    DrawClassicReorderContent(totalScale);
                }
                finally
                {
        ...
        private void DrawClassicCharacterRow(Character character, int index, float scale)
{
        ...
        private void ClassicPopScaledStyles()
{
        ...
        private void DrawClassicReorderContent(float scale)
{
            ...
            DrawClassicCharacterList(scale);
            ImGui.EndChild();
        ...
        private void DrawClassicCharacterList(float scale)
{
            for (int i = 0; i < reorderBuffer.Count; i++)
            {
                ...
                ImGui.PushID(i);
                DrawClassicCharacterRow(character, i, scale);
                ImGui.PopID();
            }
        }
