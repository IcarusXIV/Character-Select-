...
{
    public partial class ImGuiFileBrowserWindow
    {
        private void DrawClassicLayout()
{
        ...
        private void DrawClassicPathBar()
{
            // Navigation buttons
        ...
        private void DrawClassicQuickAccess()
{
            // Header
            ImGui.PushFont(UiBuilder.IconFont);
        ...
        private void DrawClassicFileListHeader()
{
        ...
        private void DrawClassicFileListContent()
{
            // Directories
        ...
        private void DrawClassicPreview()
{
            ImGui.PushFont(UiBuilder.IconFont);
        ...
        private void DrawClassicBottomBar()
{
        ...
        private void ClassicRefreshDirectory()
{
            try
            {
        ...
        private void ClassicNavigateTo(string path)
{
