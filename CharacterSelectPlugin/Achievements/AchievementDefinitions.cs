...
namespace CharacterSelectPlugin.Achievements
{
    ...
    public static class AchievementRegistry
    {
        public static readonly AchievementDefinition[] All =
        {
            ...
            new() { Id = "discover_mods",       Name = "Under the Hood",       Description = "Open the Conflict Resolution Mod Manager.", CompletedDescription = "Opened the Mod Manager.",       FlavourText = "Tinker time.",                          Hint = "Enable Conflict Resolution in Settings, then use /select mods or the Configure Mods button on a character/design.", Category = AchievementCategory.Discovery, Tier = AchievementTier.Bronze, Points = 3 },
